...
export function getDeviceInfo(
    ...
    const userAgent = headers.get("user-agent") || defaultUserAgent;
    ...
    if (userAgent === "Amazon CloudFront") {
        ...
        if (headers.get("cloudfront-is-ios-viewer") === "true") {
            ios = true;
        }

        if (headers.get("cloudfront-is-android-viewer") === "true") {
            android = true;
        }
    } else if (headers.get("cf-device-type")) {
        // Cloudflare
        switch (headers.get("cf-device-type")) {
            case "mobile":
                mobile = true;
                mobileOrTablet = true;
